"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{5002:function(e,t,n){n.d(t,{B$:function(){return iV},Bt:function(){return sM},ET:function(){return sb},IO:function(){return su},JU:function(){return iM},PL:function(){return sS},QT:function(){return sC},Xo:function(){return sm},ad:function(){return iU},ar:function(){return sc},cf:function(){return sD},hJ:function(){return iL},oe:function(){return sk},qs:function(){return sO},r7:function(){return sN}});var r,i,s,a,o=n(9279),l=n(2680),u=n(9053),h=n(3943),c=n(6552),d=n(4575);n(357);var f=n(6300).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sC(e){e=iN(e,iR);let t=iN(e.firestore,iP);return(function(e,t,n={}){let r=new S;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new im({next:o=>{s.Za(),t.enqueueAndForget(()=>rB(e,a));let l=o.docs.has(n);!l&&o.fromCache?i.reject(new A(C.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&o.fromCache&&r&&"server"===r.source?i.reject(new A(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(o)},error:e=>i.reject(e)}),a=new rQ(e5(n.path),s,{includeMetadataChanges:!0,_a:!0});return rq(e,a)})(await i_(e),e.asyncQueue,t,n,r)),r.promise})(iq(t),e._key).then(n=>sx(t,e,n))}class sA extends sv{constructor(e){super(),this.firestore=e}convertBytes(e){return new iB(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iR(this.firestore,null,t)}}function sS(e){e=iN(e,iD);let t=iN(e.firestore,iP),n=iq(t),r=new sA(t);return sa(e._query),(function(e,t,n={}){let r=new S;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new im({next:n=>{s.Za(),t.enqueueAndForget(()=>rB(e,a)),n.fromCache&&"server"===r.source?i.reject(new A(C.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),a=new rQ(n,s,{includeMetadataChanges:!0,_a:!0});return rq(e,a)})(await i_(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new sI(t,r,e,n))}function sN(e,t,n,...r){e=iN(e,iR);let i=iN(e.firestore,iP),s=iJ(i);return sR(i,[("string"==typeof(t=(0,h.m9)(t))||t instanceof i$?i3(s,"updateDoc",e._key,t,n,r):i2(s,"updateDoc",e._key,t)).toMutation(e._key,tL.exists(!0))])}function sk(e){return sR(iN(e.firestore,iP),[new tK(e._key,tL.none())])}function sb(e,t){let n=iN(e.firestore,iP),r=iM(e),i=sw(e.converter,t);return sR(n,[iZ(iJ(e.firestore),"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,tL.exists(!1))]).then(()=>r)}function sD(e,...t){var n,r,i;let s,a,o;e=(0,h.m9)(e);let l={includeMetadataChanges:!1,source:"default"},u=0;"object"!=typeof t[0]||iF(t[u])||(l=t[u],u++);let c={includeMetadataChanges:l.includeMetadataChanges,source:l.source};if(iF(t[u])){let e=t[u];t[u]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[u+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[u+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}if(e instanceof iR)a=iN(e.firestore,iP),o=e5(e._key.path),s={next:n=>{t[u]&&t[u](sx(a,e,n))},error:t[u+1],complete:t[u+2]};else{let n=iN(e,iD);a=iN(n.firestore,iP),o=n._query;let r=new sA(a);s={next:e=>{t[u]&&t[u](new sI(a,r,n,e))},error:t[u+1],complete:t[u+2]},sa(e._query)}return function(e,t,n,r){let i=new im(r),s=new rQ(t,i,n);return e.asyncQueue.enqueueAndForget(async()=>rq(await i_(e),s)),()=>{i.Za(),e.asyncQueue.enqueueAndForget(async()=>rB(await i_(e),s))}}(iq(a),o,c,s)}function sR(e,t){return function(e,t){let n=new S;return e.asyncQueue.enqueueAndForget(async()=>r4(await iw(e).then(e=>e.syncEngine),t,n)),n.promise}(iq(e),t)}function sx(e,t,n){let r=n.docs.get(t._key),i=new sA(e);return new sE(e,i,t._key,r,new s_(n.hasPendingWrites,n.fromCache),t.converter)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
